      ...
      <div class="bg-white rounded-lg p-4 mb-4 shadow-md">
        <div class="flex items-center justify-between flex-wrap gap-3">
          ...
          <div class="flex items-center gap-2">
            <!-- Audio Playing Toggle (for testing lip-sync) -->
            <label class="flex items-center gap-2 cursor-pointer">
              <input
                type="checkbox"
              ...
              />
              <span class="text-sm text-gray-700">Simulate Audio Playing</span>
            </label>
            <button
              @click="clearMessages"
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div class="bg-white rounded-lg shadow-md flex flex-col h-[600px]">
          <div class="p-3 border-b border-gray-200">
            ...
            <p class="text-xs text-gray-500">
              {{ useMockMode ? "Mock mode - try 'avatar' or 'show'" : "Real API mode" }}
            </p>
          </div>
          ...
          <div class="p-3 border-t border-gray-200">
            <div class="flex gap-2">
              <input
                ...
                type="text"
                placeholder="Type a message... (try 'show avatar')"
                :disabled="isLoading"
        ...
        <div class="space-y-4">
          ...
          <div v-else class="bg-white rounded-lg shadow-md p-8 text-center text-gray-500">
            ...
            <p class="text-sm mt-2">Try: "show avatar" or click a Quick Sample button</p>
          </div>
...
// Audio playing state for testing lip-sync
